...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link active" href="Clientes.jsp">Clientes</a>
...
<form class="justify-content-center">
  ...
  <div class="row px-4" >
    <div class="col-md-4 px-4">
      ...
      <input name="cedula" class="form-control" id="cedula" placeholder="Cedula">
    </div>
    <div class="col-md-4 px-4">
    ...
    <div class="col-md-4 px-4">
      ...
      <input name="nombreC" class="form-control" id="nombreC" placeholder="Nombre Completo">
    </div>
    <div class="col-md-4 px-4">
      <label for="inputPassword4">Correo Electronico</label>
      <input name="correo" type="email" class="form-control" id="correo" placeholder="Correo Electronico">
    </div>
  </div>
  <div class="row px-4">
